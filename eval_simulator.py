...
def main():
    ...
    parser.add_argument('--task_path', type=str, default="data/tasks/8_vcpu/data.txt")
    parser.add_argument('--compute_model', type=str, default="models/compute_8.pt")
    parser.add_argument('--fw_comm_model', type=str, default="models/comm_8_fw.pt")
    parser.add_argument('--bw_comm_model', type=str, default="models/comm_8_bw.pt")
